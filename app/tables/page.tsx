    ...
    <DashboardLayout title="Tables">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage tables and track their availability</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-12">
        <div className="flex flex-col items-center justify-center text-center">
          <div className="w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center mb-4">
            <Grid3X3 size={32} className="text-blue-500" />
          </div>
          <h3 className="text-lg font-semibold text-gray-800 mb-2">No Tables Added</h3>
          <p className="text-sm text-gray-400 max-w-md">
            Add tables for each hall to manage seating, reservations, and order assignment.
          </p>
        </div>
      </div>
    </DashboardLayout>
